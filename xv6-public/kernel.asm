...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 43 7c 10 80 	movl   $0x80107c43,(%esp)
...
80100916:	e8 a5 38 00 00       	call   801041c0 <wakeup>
...
80100d3c:	e8 4f 62 00 00       	call   80106f90 <freevm>
  return 0;
...
801020f1:	e8 ca 20 00 00       	call   801041c0 <wakeup>
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 a6 14 00 00       	call   801041c0 <wakeup>
    release(&log.lock);
...
80102d40:	e8 7b 14 00 00       	call   801041c0 <wakeup>
  release(&log.lock);
...
80102e62:	e8 69 2c 00 00       	call   80105ad0 <idtinit>
...
80102ec1:	e8 ca 41 00 00       	call   80107090 <kvmalloc>
...
80102ee9:	e8 82 08 00 00       	call   80103770 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 5d 2b 00 00       	call   80105a50 <tvinit>
  binit();         // buffer cache
...
8010337f:	e8 3c 0e 00 00       	call   801041c0 <wakeup>
...
801033c4:	e8 f7 0d 00 00       	call   801041c0 <wakeup>
...
80103454:	e8 67 0d 00 00       	call   801041c0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103459:	5a                   	pop    %edx
8010345a:	59                   	pop    %ecx
...
801034e3:	e8 d8 0c 00 00       	call   801041c0 <wakeup>
  release(&p->lock);
...
801035d7:	e8 e4 0b 00 00       	call   801041c0 <wakeup>
  release(&p->lock);
...
80103626:	81 fb 74 53 11 80    	cmp    $0x80115374,%ebx
8010362c:	0f 83 be 00 00 00    	jae    801036f0 <allocproc+0xf0>
    if(p->state == UNUSED)
...
80103653:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103659:	e8 42 11 00 00       	call   801047a0 <release>
...
8010366b:	0f 84 98 00 00 00    	je     80103709 <allocproc+0x109>
    return 0;
  }
...
8010367f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103682:	c7 40 14 3f 5a 10 80 	movl   $0x80105a3f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103691:	e8 5a 11 00 00       	call   801047f0 <memset>
...
8010369b:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
8010369e:	c7 40 10 20 37 10 80 	movl   $0x80103720,0x10(%eax)
  p->current_pass = 0;
801036a5:	d9 93 84 00 00 00    	fsts   0x84(%ebx)
  p->lv_MLFQ = 0;
801036ab:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  p->ticks = 0;
801036b2:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801036b9:	00 00 00 
  p->cpu_share = 0;
801036bc:	c7 83 8c 00 00 00 00 	movl   $0x0,0x8c(%ebx)
801036c3:	00 00 00 
  p->stride = 0;
801036c6:	d9 9b 88 00 00 00    	fstps  0x88(%ebx)
  p->proc_order = 0;
801036cc:	c7 83 90 00 00 00 00 	movl   $0x0,0x90(%ebx)
801036d3:	00 00 00 
  p->state_check = 0;
801036d6:	c7 83 94 00 00 00 00 	movl   $0x0,0x94(%ebx)
801036dd:	00 00 00 
}
801036e0:	89 d8                	mov    %ebx,%eax
...
801036fa:	e8 a1 10 00 00       	call   801047a0 <release>
}
...
80103712:	eb cc                	jmp    801036e0 <allocproc+0xe0>
...
8010372b:	e8 70 10 00 00       	call   801047a0 <release>
...
80103776:	68 15 78 10 80       	push   $0x80107815
8010377b:	68 40 2d 11 80       	push   $0x80112d40
80103780:	e8 1b 0e 00 00       	call   801045a0 <initlock>
}
...
80103834:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103837:	e8 d4 0d 00 00       	call   80104610 <pushcli>
  c = mycpu();
8010383c:	e8 4f ff ff ff       	call   80103790 <mycpu>
  p = c->proc;
80103841:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103847:	e8 04 0e 00 00       	call   80104650 <popcli>
}
...
80103873:	e8 98 37 00 00       	call   80107010 <setupkvm>
...
80103891:	e8 5a 34 00 00       	call   80106cf0 <inituvm>
...
801038a6:	e8 45 0f 00 00       	call   801047f0 <memset>
...
801038ff:	68 45 78 10 80       	push   $0x80107845
80103904:	50                   	push   %eax
80103905:	e8 c6 10 00 00       	call   801049d0 <safestrcpy>
  p->cwd = namei("/");
8010390a:	c7 04 24 4e 78 10 80 	movl   $0x8010784e,(%esp)
...
80103943:	68 2c 78 10 80       	push   $0x8010782c
...
80103955:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103958:	e8 b3 0c 00 00       	call   80104610 <pushcli>
  c = mycpu();
8010395d:	e8 2e fe ff ff       	call   80103790 <mycpu>
  p = c->proc;
80103962:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103968:	e8 e3 0c 00 00       	call   80104650 <popcli>
  if(n > 0){
...
8010397c:	e8 5f 32 00 00       	call   80106be0 <switchuvm>
  return 0;
...
8010399a:	e8 91 34 00 00       	call   80106e30 <allocuvm>
...
801039ba:	e8 a1 35 00 00       	call   80106f60 <deallocuvm>
...
801039d6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039d9:	e8 32 0c 00 00       	call   80104610 <pushcli>
  c = mycpu();
801039de:	e8 ad fd ff ff       	call   80103790 <mycpu>
  p = c->proc;
801039e3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039e9:	e8 62 0c 00 00       	call   80104650 <popcli>
  if((np = allocproc()) == 0){
...
80103a08:	e8 d3 36 00 00       	call   801070e0 <copyuvm>
...
80103af9:	e8 92 fc ff ff       	call   80103790 <mycpu>
  c->proc = 0;
80103afe:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103b05:	00 00 00 
  struct cpu *c = mycpu();
80103b08:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b0b:	83 c0 04             	add    $0x4,%eax
80103b0e:	89 45 e0             	mov    %eax,-0x20(%ebp)
...
80103b1c:	31 db                	xor    %ebx,%ebx
    tmp = 0;
80103b1e:	31 f6                	xor    %esi,%esi
    acquire(&ptable.lock);
80103b20:	68 40 2d 11 80       	push   $0x80112d40
80103b25:	e8 b6 0b 00 00       	call   801046e0 <acquire>
    float min_pass = total_MLFQ.current_pass;
80103b2a:	d9 05 28 2d 11 80    	flds   0x80112d28
80103b30:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b33:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
    float min_pass = total_MLFQ.current_pass;
80103b38:	d9 c0                	fld    %st(0)
80103b3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->state != RUNNABLE)
80103b40:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103b44:	75 2a                	jne    80103b70 <scheduler+0x80>
      if(p->state_check == 0 && p->current_pass < min_pass){
80103b46:	8b 90 94 00 00 00    	mov    0x94(%eax),%edx
      count += 1;
80103b4c:	83 c3 01             	add    $0x1,%ebx
      if(p->state_check == 0 && p->current_pass < min_pass){
80103b4f:	85 d2                	test   %edx,%edx
80103b51:	75 1d                	jne    80103b70 <scheduler+0x80>
80103b53:	d9 80 84 00 00 00    	flds   0x84(%eax)
80103b59:	d9 c9                	fxch   %st(1)
80103b5b:	db e9                	fucomi %st(1),%st
80103b5d:	76 09                	jbe    80103b68 <scheduler+0x78>
80103b5f:	dd d8                	fstp   %st(0)
80103b61:	89 c6                	mov    %eax,%esi
80103b63:	eb 0b                	jmp    80103b70 <scheduler+0x80>
80103b65:	8d 76 00             	lea    0x0(%esi),%esi
80103b68:	dd d9                	fstp   %st(1)
80103b6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b70:	05 98 00 00 00       	add    $0x98,%eax
80103b75:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103b7a:	72 c4                	jb     80103b40 <scheduler+0x50>
80103b7c:	dd d8                	fstp   %st(0)
    if(tmp == 0){
80103b7e:	85 f6                	test   %esi,%esi
80103b80:	74 1f                	je     80103ba1 <scheduler+0xb1>
80103b82:	dd d8                	fstp   %st(0)
    else if(p == tmp){
80103b84:	39 c6                	cmp    %eax,%esi
80103b86:	0f 84 98 00 00 00    	je     80103c24 <scheduler+0x134>
    release(&ptable.lock);
80103b8c:	83 ec 0c             	sub    $0xc,%esp
80103b8f:	68 40 2d 11 80       	push   $0x80112d40
80103b94:	e8 07 0c 00 00       	call   801047a0 <release>
  for(;;){
80103b99:	83 c4 10             	add    $0x10,%esp
80103b9c:	e9 77 ff ff ff       	jmp    80103b18 <scheduler+0x28>
        if(total_MLFQ.checker_tick == PRIORITY_BOOST_TIME){
80103ba1:	83 3d 24 2d 11 80 64 	cmpl   $0x64,0x80112d24
80103ba8:	0f 84 d6 00 00 00    	je     80103c84 <scheduler+0x194>
        int min_order = 999999;
80103bae:	bf 3f 42 0f 00       	mov    $0xf423f,%edi
        int this_MLFQ = 2;
80103bb3:	b9 02 00 00 00       	mov    $0x2,%ecx
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103bb8:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103bbd:	eb 17                	jmp    80103bd6 <scheduler+0xe6>
80103bbf:	90                   	nop
                min_order = p->proc_order;
80103bc0:	8b b8 90 00 00 00    	mov    0x90(%eax),%edi
80103bc6:	89 d1                	mov    %edx,%ecx
80103bc8:	89 c6                	mov    %eax,%esi
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103bca:	05 98 00 00 00       	add    $0x98,%eax
80103bcf:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103bd4:	73 29                	jae    80103bff <scheduler+0x10f>
            if (p->state != RUNNABLE)
80103bd6:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103bda:	75 ee                	jne    80103bca <scheduler+0xda>
            if (p->lv_MLFQ < this_MLFQ) {
80103bdc:	8b 50 7c             	mov    0x7c(%eax),%edx
80103bdf:	39 ca                	cmp    %ecx,%edx
80103be1:	7c dd                	jl     80103bc0 <scheduler+0xd0>
            else if (p->lv_MLFQ == this_MLFQ && p->proc_order < min_order) {
80103be3:	75 e5                	jne    80103bca <scheduler+0xda>
80103be5:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
80103beb:	39 fa                	cmp    %edi,%edx
80103bed:	7d db                	jge    80103bca <scheduler+0xda>
80103bef:	89 c6                	mov    %eax,%esi
        for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103bf1:	05 98 00 00 00       	add    $0x98,%eax
80103bf6:	89 d7                	mov    %edx,%edi
80103bf8:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103bfd:	72 d7                	jb     80103bd6 <scheduler+0xe6>
        if (p == tmp) {
80103bff:	39 c6                	cmp    %eax,%esi
80103c01:	0f 84 c5 00 00 00    	je     80103ccc <scheduler+0x1dc>
        if(count == 0){
80103c07:	85 db                	test   %ebx,%ebx
80103c09:	74 68                	je     80103c73 <scheduler+0x183>
        total_MLFQ.current_pass += (float)(1000 / (float)100 - total_MLFQ.cpu_percentage);
80103c0b:	db 05 20 2d 11 80    	fildl  0x80112d20
80103c11:	d8 2d 38 79 10 80    	fsubrs 0x80107938
80103c17:	de c1                	faddp  %st,%st(1)
80103c19:	d9 1d 28 2d 11 80    	fstps  0x80112d28
80103c1f:	e9 68 ff ff ff       	jmp    80103b8c <scheduler+0x9c>
        c->proc = p;
80103c24:	8b 7d e4             	mov    -0x1c(%ebp),%edi
        switchuvm(p);
80103c27:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103c2a:	89 b7 ac 00 00 00    	mov    %esi,0xac(%edi)
        switchuvm(p);
80103c30:	56                   	push   %esi
80103c31:	e8 aa 2f 00 00       	call   80106be0 <switchuvm>
        p->state = RUNNING;
80103c36:	c7 46 0c 04 00 00 00 	movl   $0x4,0xc(%esi)
        swtch(&(c->scheduler), p->context);
80103c3d:	58                   	pop    %eax
80103c3e:	5a                   	pop    %edx
80103c3f:	ff 76 1c             	pushl  0x1c(%esi)
80103c42:	ff 75 e0             	pushl  -0x20(%ebp)
80103c45:	e8 e1 0d 00 00       	call   80104a2b <swtch>
        switchkvm();
80103c4a:	e8 71 2f 00 00       	call   80106bc0 <switchkvm>
        p->current_pass += p->stride;
80103c4f:	d9 86 84 00 00 00    	flds   0x84(%esi)
        c->proc = 0;
80103c55:	83 c4 10             	add    $0x10,%esp
        p->current_pass += p->stride;
80103c58:	d8 86 88 00 00 00    	fadds  0x88(%esi)
80103c5e:	d9 9e 84 00 00 00    	fstps  0x84(%esi)
        c->proc = 0;
80103c64:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103c6b:	00 00 00 
80103c6e:	e9 19 ff ff ff       	jmp    80103b8c <scheduler+0x9c>
80103c73:	dd d8                	fstp   %st(0)
            total_MLFQ.current_pass = 0;
80103c75:	c7 05 28 2d 11 80 00 	movl   $0x0,0x80112d28
80103c7c:	00 00 00 
80103c7f:	e9 08 ff ff ff       	jmp    80103b8c <scheduler+0x9c>
            for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c84:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103c89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                if(p->state != RUNNABLE)
80103c90:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c94:	75 1b                	jne    80103cb1 <scheduler+0x1c1>
                p->lv_MLFQ = 0;
80103c96:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
                p->ticks = 0;
80103c9d:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80103ca4:	00 00 00 
                p->proc_order = 0;
80103ca7:	c7 80 90 00 00 00 00 	movl   $0x0,0x90(%eax)
80103cae:	00 00 00 
            for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb1:	05 98 00 00 00       	add    $0x98,%eax
80103cb6:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103cbb:	72 d3                	jb     80103c90 <scheduler+0x1a0>
            total_MLFQ.checker_tick = 0;
80103cbd:	c7 05 24 2d 11 80 00 	movl   $0x0,0x80112d24
80103cc4:	00 00 00 
80103cc7:	e9 e2 fe ff ff       	jmp    80103bae <scheduler+0xbe>
80103ccc:	dd d8                	fstp   %st(0)
            c->proc = p;
80103cce:	8b 7d e4             	mov    -0x1c(%ebp),%edi
            switchuvm(p);
80103cd1:	83 ec 0c             	sub    $0xc,%esp
            c->proc = p;
80103cd4:	89 b7 ac 00 00 00    	mov    %esi,0xac(%edi)
            switchuvm(p);
80103cda:	56                   	push   %esi
80103cdb:	e8 00 2f 00 00       	call   80106be0 <switchuvm>
            p->state = RUNNING;
80103ce0:	c7 46 0c 04 00 00 00 	movl   $0x4,0xc(%esi)
            swtch(&(c->scheduler), p->context);
80103ce7:	59                   	pop    %ecx
80103ce8:	58                   	pop    %eax
80103ce9:	ff 76 1c             	pushl  0x1c(%esi)
80103cec:	ff 75 e0             	pushl  -0x20(%ebp)
80103cef:	e8 37 0d 00 00       	call   80104a2b <swtch>
            switchkvm();
80103cf4:	e8 c7 2e 00 00       	call   80106bc0 <switchkvm>
            p->ticks += 1;
80103cf9:	83 86 80 00 00 00 01 	addl   $0x1,0x80(%esi)
            c->proc = 0;
80103d00:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103d07:	00 00 00 
            if (p->lv_MLFQ == 0) {
80103d0a:	83 c4 10             	add    $0x10,%esp
80103d0d:	8b 46 7c             	mov    0x7c(%esi),%eax
            total_MLFQ.checker_tick += 1;
80103d10:	83 05 24 2d 11 80 01 	addl   $0x1,0x80112d24
            if (p->lv_MLFQ == 0) {
80103d17:	85 c0                	test   %eax,%eax
80103d19:	75 25                	jne    80103d40 <scheduler+0x250>
                if (p->ticks >= H_QUEUE_ALLOTMENT) {
80103d1b:	83 be 80 00 00 00 04 	cmpl   $0x4,0x80(%esi)
80103d22:	7e 3a                	jle    80103d5e <scheduler+0x26e>
                    p->ticks = 0;
80103d24:	c7 86 80 00 00 00 00 	movl   $0x0,0x80(%esi)
80103d2b:	00 00 00 
                    p->lv_MLFQ += 1;
80103d2e:	c7 46 7c 01 00 00 00 	movl   $0x1,0x7c(%esi)
80103d35:	d9 05 28 2d 11 80    	flds   0x80112d28
80103d3b:	e9 c7 fe ff ff       	jmp    80103c07 <scheduler+0x117>
            else if (p->lv_MLFQ == 1) {
80103d40:	83 f8 01             	cmp    $0x1,%eax
80103d43:	74 25                	je     80103d6a <scheduler+0x27a>
            else if (p->lv_MLFQ == 2) {
80103d45:	83 f8 02             	cmp    $0x2,%eax
80103d48:	74 0b                	je     80103d55 <scheduler+0x265>
80103d4a:	d9 05 28 2d 11 80    	flds   0x80112d28
80103d50:	e9 b2 fe ff ff       	jmp    80103c07 <scheduler+0x117>
                if (p->ticks >= L_QUEUE_QUANTUM) {
80103d55:	83 be 80 00 00 00 03 	cmpl   $0x3,0x80(%esi)
80103d5c:	7e ec                	jle    80103d4a <scheduler+0x25a>
                    p->proc_order = current_order + 1;
80103d5e:	c7 86 90 00 00 00 01 	movl   $0x1,0x90(%esi)
80103d65:	00 00 00 
80103d68:	eb e0                	jmp    80103d4a <scheduler+0x25a>
                if (p->ticks >= M_QUEUE_ALLOTMENT) {
80103d6a:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
80103d70:	83 f8 09             	cmp    $0x9,%eax
80103d73:	7e 1c                	jle    80103d91 <scheduler+0x2a1>
                    p->ticks = 0;
80103d75:	c7 86 80 00 00 00 00 	movl   $0x0,0x80(%esi)
80103d7c:	00 00 00 
                    p->lv_MLFQ += 1;
80103d7f:	c7 46 7c 02 00 00 00 	movl   $0x2,0x7c(%esi)
80103d86:	d9 05 28 2d 11 80    	flds   0x80112d28
80103d8c:	e9 76 fe ff ff       	jmp    80103c07 <scheduler+0x117>
                else if (p->ticks % M_QUEUE_QUANTUM == 0) {
80103d91:	a8 01                	test   $0x1,%al
80103d93:	75 b5                	jne    80103d4a <scheduler+0x25a>
                    p->proc_order = current_order + 1;
80103d95:	c7 86 90 00 00 00 01 	movl   $0x1,0x90(%esi)
80103d9c:	00 00 00 
80103d9f:	eb a9                	jmp    80103d4a <scheduler+0x25a>
...
80103df7:	75 41                	jne    80103e3a <sched+0x8a>
  intena = mycpu()->intena;
80103df9:	e8 92 f9 ff ff       	call   80103790 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103dfe:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e01:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e07:	e8 84 f9 ff ff       	call   80103790 <mycpu>
80103e0c:	83 ec 08             	sub    $0x8,%esp
80103e0f:	ff 70 04             	pushl  0x4(%eax)
80103e12:	53                   	push   %ebx
80103e13:	e8 13 0c 00 00       	call   80104a2b <swtch>
  mycpu()->intena = intena;
80103e18:	e8 73 f9 ff ff       	call   80103790 <mycpu>
}
...
80103e76:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103e79:	e8 92 07 00 00       	call   80104610 <pushcli>
  c = mycpu();
80103e7e:	e8 0d f9 ff ff       	call   80103790 <mycpu>
  p = c->proc;
80103e83:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e89:	e8 c2 07 00 00       	call   80104650 <popcli>
  if(curproc == initproc)
80103e8e:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103e94:	8d 5e 28             	lea    0x28(%esi),%ebx
80103e97:	8d 7e 68             	lea    0x68(%esi),%edi
80103e9a:	0f 84 01 01 00 00    	je     80103fa1 <exit+0x131>
    if(curproc->ofile[fd]){
...
80103eaa:	e8 91 cf ff ff       	call   80100e40 <fileclose>
      curproc->ofile[fd] = 0;
80103eaf:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80103eb5:	83 c4 10             	add    $0x10,%esp
80103eb8:	83 c3 04             	add    $0x4,%ebx
  for(fd = 0; fd < NOFILE; fd++){
80103ebb:	39 fb                	cmp    %edi,%ebx
80103ebd:	75 e1                	jne    80103ea0 <exit+0x30>
  begin_op();
80103ebf:	e8 dc ec ff ff       	call   80102ba0 <begin_op>
  iput(curproc->cwd);
80103ec4:	83 ec 0c             	sub    $0xc,%esp
80103ec7:	ff 76 68             	pushl  0x68(%esi)
80103eca:	e8 e1 d8 ff ff       	call   801017b0 <iput>
  end_op();
80103ecf:	e8 3c ed ff ff       	call   80102c10 <end_op>
  curproc->cwd = 0;
80103ed4:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103edb:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103ee2:	e8 f9 07 00 00       	call   801046e0 <acquire>
  wakeup1(curproc->parent);
80103ee7:	8b 56 14             	mov    0x14(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103eed:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103ef2:	eb 10                	jmp    80103f04 <exit+0x94>
80103ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ef8:	05 98 00 00 00       	add    $0x98,%eax
80103efd:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103f02:	73 1e                	jae    80103f22 <exit+0xb2>
    if(p->state == SLEEPING && p->chan == chan)
80103f04:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103f08:	75 ee                	jne    80103ef8 <exit+0x88>
80103f0a:	3b 50 20             	cmp    0x20(%eax),%edx
80103f0d:	75 e9                	jne    80103ef8 <exit+0x88>
      p->state = RUNNABLE;
80103f0f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f16:	05 98 00 00 00       	add    $0x98,%eax
80103f1b:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103f20:	72 e2                	jb     80103f04 <exit+0x94>
      p->parent = initproc;
80103f22:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f28:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
80103f2d:	eb 0f                	jmp    80103f3e <exit+0xce>
80103f2f:	90                   	nop
80103f30:	81 c2 98 00 00 00    	add    $0x98,%edx
80103f36:	81 fa 74 53 11 80    	cmp    $0x80115374,%edx
80103f3c:	73 3a                	jae    80103f78 <exit+0x108>
    if(p->parent == curproc){
...
80103f4a:	75 e4                	jne    80103f30 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f4c:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103f51:	eb 11                	jmp    80103f64 <exit+0xf4>
80103f53:	90                   	nop
80103f54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f58:	05 98 00 00 00       	add    $0x98,%eax
80103f5d:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80103f62:	73 cc                	jae    80103f30 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
...
80103f78:	a1 20 2d 11 80       	mov    0x80112d20,%eax
80103f7d:	2b 86 8c 00 00 00    	sub    0x8c(%esi),%eax
  curproc->state = ZOMBIE;
80103f83:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  total_MLFQ.cpu_percentage -= curproc->cpu_share;
80103f8a:	a3 20 2d 11 80       	mov    %eax,0x80112d20
  sched();
80103f8f:	e8 1c fe ff ff       	call   80103db0 <sched>
  panic("zombie exit");
80103f94:	83 ec 0c             	sub    $0xc,%esp
80103f97:	68 9d 78 10 80       	push   $0x8010789d
80103f9c:	e8 ef c3 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103fa1:	83 ec 0c             	sub    $0xc,%esp
80103fa4:	68 90 78 10 80       	push   $0x80107890
80103fa9:	e8 e2 c3 ff ff       	call   80100390 <panic>
...
80103fbc:	e8 1f 07 00 00       	call   801046e0 <acquire>
  pushcli();
80103fc1:	e8 4a 06 00 00       	call   80104610 <pushcli>
  c = mycpu();
80103fc6:	e8 c5 f7 ff ff       	call   80103790 <mycpu>
  p = c->proc;
80103fcb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fd1:	e8 7a 06 00 00       	call   80104650 <popcli>
...
80103fe9:	e8 b2 07 00 00       	call   801047a0 <release>
}
...
8010400c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010400f:	e8 fc 05 00 00       	call   80104610 <pushcli>
  c = mycpu();
80104014:	e8 77 f7 ff ff       	call   80103790 <mycpu>
  p = c->proc;
80104019:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010401f:	e8 2c 06 00 00       	call   80104650 <popcli>
  if(p == 0)
...
80104040:	e8 9b 06 00 00       	call   801046e0 <acquire>
    release(lk);
80104045:	89 34 24             	mov    %esi,(%esp)
80104048:	e8 53 07 00 00       	call   801047a0 <release>
  p->chan = chan;
...
8010406a:	e8 31 07 00 00       	call   801047a0 <release>
    acquire(lk);
...
8010407b:	5d                   	pop    %ebp
    acquire(lk);
8010407c:	e9 5f 06 00 00       	jmp    801046e0 <acquire>
...
801040a9:	68 af 78 10 80       	push   $0x801078af
801040ae:	e8 dd c2 ff ff       	call   80100390 <panic>
    panic("sleep");
801040b3:	83 ec 0c             	sub    $0xc,%esp
801040b6:	68 a9 78 10 80       	push   $0x801078a9
...
801040c5:	e8 46 05 00 00       	call   80104610 <pushcli>
  c = mycpu();
801040ca:	e8 c1 f6 ff ff       	call   80103790 <mycpu>
  p = c->proc;
801040cf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040d5:	e8 76 05 00 00       	call   80104650 <popcli>
  acquire(&ptable.lock);
801040da:	83 ec 0c             	sub    $0xc,%esp
801040dd:	68 40 2d 11 80       	push   $0x80112d40
801040e2:	e8 f9 05 00 00       	call   801046e0 <acquire>
801040e7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801040ea:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040ec:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
801040f1:	eb 13                	jmp    80104106 <wait+0x46>
801040f3:	90                   	nop
801040f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040f8:	81 c3 98 00 00 00    	add    $0x98,%ebx
801040fe:	81 fb 74 53 11 80    	cmp    $0x80115374,%ebx
...
8010410f:	74 37                	je     80104148 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104111:	81 c3 98 00 00 00    	add    $0x98,%ebx
      havekids = 1;
80104117:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010411c:	81 fb 74 53 11 80    	cmp    $0x80115374,%ebx
...
8010415a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104161:	e8 2a 2e 00 00       	call   80106f90 <freevm>
        release(&ptable.lock);
80104166:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
        p->pid = 0;
...
80104186:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010418d:	e8 0e 06 00 00       	call   801047a0 <release>
        return pid;
...
801041a1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801041a6:	68 40 2d 11 80       	push   $0x80112d40
801041ab:	e8 f0 05 00 00       	call   801047a0 <release>
      return -1;
...
801041cf:	e8 0c 05 00 00       	call   801046e0 <acquire>
...
801041e5:	3d 74 53 11 80       	cmp    $0x80115374,%eax
801041ea:	73 1e                	jae    8010420a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
...
801041f7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041fe:	05 98 00 00 00       	add    $0x98,%eax
80104203:	3d 74 53 11 80       	cmp    $0x80115374,%eax
80104208:	72 e2                	jb     801041ec <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010420a:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
80104211:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104214:	c9                   	leave  
  release(&ptable.lock);
80104215:	e9 86 05 00 00       	jmp    801047a0 <release>
...
8010422f:	e8 ac 04 00 00       	call   801046e0 <acquire>
...
80104240:	05 98 00 00 00       	add    $0x98,%eax
80104245:	3d 74 53 11 80       	cmp    $0x80115374,%eax
8010424a:	73 34                	jae    80104280 <kill+0x60>
    if(p->pid == pid){
...
80104268:	68 40 2d 11 80       	push   $0x80112d40
8010426d:	e8 2e 05 00 00       	call   801047a0 <release>
      return 0;
...
80104288:	e8 13 05 00 00       	call   801047a0 <release>
  return -1;
...
801042bb:	68 43 7c 10 80       	push   $0x80107c43
801042c0:	e8 9b c3 ff ff       	call   80100660 <cprintf>
801042c5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042c8:	81 c3 98 00 00 00    	add    $0x98,%ebx
801042ce:	81 fb 74 53 11 80    	cmp    $0x80115374,%ebx
...
801042e1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801042e4:	ba c0 78 10 80       	mov    $0x801078c0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042e9:	77 11                	ja     801042fc <procdump+0x5c>
801042eb:	8b 14 85 20 79 10 80 	mov    -0x7fef86e0(,%eax,4),%edx
      state = "???";
801042f2:	b8 c0 78 10 80       	mov    $0x801078c0,%eax
...
80104304:	68 c4 78 10 80       	push   $0x801078c4
...
8010432b:	e8 90 02 00 00       	call   801045c0 <getcallerpcs>
...
80104349:	68 01 73 10 80       	push   $0x80107301
...
80104374:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104377:	e8 94 02 00 00       	call   80104610 <pushcli>
  c = mycpu();
8010437c:	e8 0f f4 ff ff       	call   80103790 <mycpu>
  p = c->proc;
80104381:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104387:	e8 c4 02 00 00       	call   80104650 <popcli>
    struct proc* p = myproc();
    if (p == 0)
8010438c:	85 db                	test   %ebx,%ebx
8010438e:	74 09                	je     80104399 <getlev+0x29>
        return -1;

    return p->lv_MLFQ;
80104390:	8b 43 7c             	mov    0x7c(%ebx),%eax
}
...
8010439e:	eb f3                	jmp    80104393 <getlev+0x23>

801043a0 <set_cpu_share>:
...
801043a8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801043ab:	e8 60 02 00 00       	call   80104610 <pushcli>
  c = mycpu();
801043b0:	e8 db f3 ff ff       	call   80103790 <mycpu>
  p = c->proc;
801043b5:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801043bb:	e8 90 02 00 00       	call   80104650 <popcli>
    struct proc* p = myproc();

    acquire(&ptable.lock);
801043c0:	83 ec 0c             	sub    $0xc,%esp
801043c3:	68 40 2d 11 80       	push   $0x80112d40
801043c8:	e8 13 03 00 00       	call   801046e0 <acquire>

    if (total_MLFQ.cpu_percentage + portion > MAX_STRIDE_PORTION) {
801043cd:	a1 20 2d 11 80       	mov    0x80112d20,%eax
801043d2:	83 c4 10             	add    $0x10,%esp
801043d5:	01 d8                	add    %ebx,%eax
801043d7:	83 f8 50             	cmp    $0x50,%eax
801043da:	7f 7a                	jg     80104456 <set_cpu_share+0xb6>
        return -1;
    }
...
801043dc:	89 5d f4             	mov    %ebx,-0xc(%ebp)
    total_MLFQ.cpu_percentage += portion;
801043df:	a3 20 2d 11 80       	mov    %eax,0x80112d20
    p->state_check = 0;
    
    total_MLFQ.current_pass = 0;

    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801043e4:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
    p->stride = (float)(1000 / (float)portion);
801043e9:	db 45 f4             	fildl  -0xc(%ebp)
    p->cpu_share = portion;
801043ec:	89 9e 8c 00 00 00    	mov    %ebx,0x8c(%esi)
    p->state_check = 0;
801043f2:	c7 86 94 00 00 00 00 	movl   $0x0,0x94(%esi)
801043f9:	00 00 00 
    total_MLFQ.current_pass = 0;
801043fc:	c7 05 28 2d 11 80 00 	movl   $0x0,0x80112d28
80104403:	00 00 00 
    p->stride = (float)(1000 / (float)portion);
80104406:	d8 3d 3c 79 10 80    	fdivrs 0x8010793c
8010440c:	d9 9e 88 00 00 00    	fstps  0x88(%esi)
80104412:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if (p->state != RUNNABLE || p->state_check == 1)
80104418:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
8010441c:	75 13                	jne    80104431 <set_cpu_share+0x91>
8010441e:	83 b8 94 00 00 00 01 	cmpl   $0x1,0x94(%eax)
80104425:	74 0a                	je     80104431 <set_cpu_share+0x91>
            continue;
        p->current_pass = 0;
80104427:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
8010442e:	00 00 00 
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104431:	05 98 00 00 00       	add    $0x98,%eax
80104436:	3d 74 53 11 80       	cmp    $0x80115374,%eax
8010443b:	72 db                	jb     80104418 <set_cpu_share+0x78>
    }

    release(&ptable.lock);
8010443d:	83 ec 0c             	sub    $0xc,%esp
80104440:	68 40 2d 11 80       	push   $0x80112d40
80104445:	e8 56 03 00 00       	call   801047a0 <release>
    return 0;
...
80104459:	68 40 2d 11 80       	push   $0x80112d40
8010445e:	e8 3d 03 00 00       	call   801047a0 <release>
        return -1;
80104463:	83 c4 10             	add    $0x10,%esp
80104466:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010446b:	eb e2                	jmp    8010444f <set_cpu_share+0xaf>
...
8010447a:	68 40 79 10 80       	push   $0x80107940
...
801044d5:	e8 26 fb ff ff       	call   80104000 <sleep>
  while (lk->locked) {
...
801044e3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044e9:	e8 42 f3 ff ff       	call   80103830 <myproc>
...
80104534:	e8 87 fc ff ff       	call   801041c0 <wakeup>
  release(&lk->lk);
...
80104573:	e8 b8 f2 ff ff       	call   80103830 <myproc>
80104578:	39 58 10             	cmp    %ebx,0x10(%eax)
...
80104619:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010461a:	e8 71 f1 ff ff       	call   80103790 <mycpu>
...
8010462f:	e8 5c f1 ff ff       	call   80103790 <mycpu>
80104634:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010463a:	e8 51 f1 ff ff       	call   80103790 <mycpu>
...
8010467c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104680:	e8 0b f1 ff ff       	call   80103790 <mycpu>
...
80104695:	68 4b 79 10 80       	push   $0x8010794b
8010469a:	e8 f1 bc ff ff       	call   80100390 <panic>
    panic("popcli");
8010469f:	83 ec 0c             	sub    $0xc,%esp
801046a2:	68 62 79 10 80       	push   $0x80107962
...
801046c8:	e8 c3 f0 ff ff       	call   80103790 <mycpu>
...
80104724:	e8 67 f0 ff ff       	call   80103790 <mycpu>
...
80104787:	68 69 79 10 80       	push   $0x80107969
...
801047dc:	68 71 79 10 80       	push   $0x80107971
...
80104a47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a4a:	e8 e1 ed ff ff       	call   80103830 <myproc>
...
80104a87:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a8a:	e8 a1 ed ff ff       	call   80103830 <myproc>
...
80104af5:	e8 36 ed ff ff       	call   80103830 <myproc>
...
80104b03:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b06:	e8 25 ed ff ff       	call   80103830 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104b48:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b4b:	e8 e0 ec ff ff       	call   80103830 <myproc>
...
80104be4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104be7:	e8 44 ec ff ff       	call   80103830 <myproc>
...
80104bfc:	8b 14 85 a0 79 10 80 	mov    -0x7fef8660(,%eax,4),%edx
...
80104c20:	68 79 79 10 80       	push   $0x80107979
...
80104d74:	68 20 7a 10 80       	push   $0x80107a20
...
80104d8c:	68 1f 7a 10 80       	push   $0x80107a1f
...
80104da5:	68 13 7a 10 80       	push   $0x80107a13
...
80104dba:	68 22 7a 10 80       	push   $0x80107a22
80104dbf:	e8 cc b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104dc4:	83 ec 0c             	sub    $0xc,%esp
80104dc7:	68 04 7a 10 80       	push   $0x80107a04
...
80104e04:	e8 27 ea ff ff       	call   80103830 <myproc>
...
80104e49:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104e4b:	e8 e0 e9 ff ff       	call   80103830 <myproc>
...
80104ebd:	e8 2e fc ff ff       	call   80104af0 <argint>
...
80104ed5:	e8 66 fc ff ff       	call   80104b40 <argptr>
...
80104f2d:	e8 be fb ff ff       	call   80104af0 <argint>
...
80104f45:	e8 f6 fb ff ff       	call   80104b40 <argptr>
...
80104f93:	78 2b                	js     80104fc0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f95:	e8 96 e8 ff ff       	call   80103830 <myproc>
...
80104fef:	e8 4c fb ff ff       	call   80104b40 <argptr>
...
8010502f:	e8 6c fb ff ff       	call   80104ba0 <argstr>
...
80105048:	e8 53 fb ff ff       	call   80104ba0 <argstr>
...
8010517f:	e8 1c fa ff ff       	call   80104ba0 <argstr>
...
801051b9:	58                   	pop    %eax
801051ba:	5a                   	pop    %edx
801051bb:	68 20 7a 10 80       	push   $0x80107a20
...
801051d4:	68 1f 7a 10 80       	push   $0x80107a1f
...
8010522e:	e8 bd f5 ff ff       	call   801047f0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801053cf:	0f 84 a6 00 00 00    	je     8010547b <sys_open+0x12b>
  struct proc *curproc = myproc();
801053d5:	e8 56 e4 ff ff       	call   80103830 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054c4:	e8 d7 f6 ff ff       	call   80104ba0 <argstr>
...
80105524:	e8 77 f6 ff ff       	call   80104ba0 <argstr>
...
80105539:	e8 b2 f5 ff ff       	call   80104af0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010554e:	e8 9d f5 ff ff       	call   80104af0 <argint>
     argint(1, &major) < 0 ||
...
801055a5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055a8:	e8 83 e2 ff ff       	call   80103830 <myproc>
...
801055bd:	e8 de f5 ff ff       	call   80104ba0 <argstr>
...
80105665:	e8 36 f5 ff ff       	call   80104ba0 <argstr>
...
80105681:	e8 6a f4 ff ff       	call   80104af0 <argint>
...
801056a6:	e8 45 f1 ff ff       	call   801047f0 <memset>
...
801056c8:	e8 b3 f3 ff ff       	call   80104a80 <fetchstr>
...
801056f0:	e8 4b f3 ff ff       	call   80104a40 <fetchint>
...
80105751:	e8 ea f3 ff ff       	call   80104b40 <argptr>
...
8010577f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105781:	e8 aa e0 ff ff       	call   80103830 <myproc>
...
801057a7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057aa:	e8 81 e0 ff ff       	call   80103830 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801057e8:	e8 43 e0 ff ff       	call   80103830 <myproc>
...
80105823:	5d                   	pop    %ebp
  return fork();
80105824:	e9 a7 e1 ff ff       	jmp    801039d0 <fork>
...
80105833:	83 ec 08             	sub    $0x8,%esp
  exit();
80105836:	e8 35 e6 ff ff       	call   80103e70 <exit>
...
80105843:	5d                   	pop    %ebp
  return wait();
80105844:	e9 77 e8 ff ff       	jmp    801040c0 <wait>
...
8010585c:	e8 8f f2 ff ff       	call   80104af0 <argint>
...
8010586e:	e8 ad e9 ff ff       	call   80104220 <kill>
...
80105893:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105896:	e8 95 df ff ff       	call   80103830 <myproc>
...
801058ad:	e8 3e f2 ff ff       	call   80104af0 <argint>
801058b2:	83 c4 10             	add    $0x10,%esp
801058b5:	85 c0                	test   %eax,%eax
801058b7:	78 27                	js     801058e0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058b9:	e8 72 df ff ff       	call   80103830 <myproc>
  if(growproc(n) < 0)
...
801058c6:	e8 85 e0 ff ff       	call   80103950 <growproc>
...
80105910:	68 80 53 11 80       	push   $0x80115380
...
8010591d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105920:	8b 1d c0 5b 11 80    	mov    0x80115bc0,%ebx
  while(ticks - ticks0 < n){
...
80105933:	68 80 53 11 80       	push   $0x80115380
80105938:	68 c0 5b 11 80       	push   $0x80115bc0
8010593d:	e8 be e6 ff ff       	call   80104000 <sleep>
  while(ticks - ticks0 < n){
80105942:	a1 c0 5b 11 80       	mov    0x80115bc0,%eax
...
8010594f:	73 2f                	jae    80105980 <sys_sleep+0x90>
    if(myproc()->killed){
80105951:	e8 da de ff ff       	call   80103830 <myproc>
...
80105960:	68 80 53 11 80       	push   $0x80115380
80105965:	e8 36 ee ff ff       	call   801047a0 <release>
      return -1;
...
80105983:	68 80 53 11 80       	push   $0x80115380
80105988:	e8 13 ee ff ff       	call   801047a0 <release>
  return 0;
...
801059a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059a7:	68 80 53 11 80       	push   $0x80115380
801059ac:	e8 2f ed ff ff       	call   801046e0 <acquire>
  xticks = ticks;
801059b1:	8b 1d c0 5b 11 80    	mov    0x80115bc0,%ebx
  release(&tickslock);
801059b7:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
801059be:	e8 dd ed ff ff       	call   801047a0 <release>
  return xticks;
}
...
801059d3:	83 ec 08             	sub    $0x8,%esp
    yield();
801059d6:	e8 d5 e5 ff ff       	call   80103fb0 <yield>
    return 0;
}
...
801059e6:	e8 45 de ff ff       	call   80103830 <myproc>
801059eb:	8b 40 7c             	mov    0x7c(%eax),%eax
}
801059ee:	c9                   	leave  
801059ef:	c3                   	ret    

801059f0 <sys_set_cpu_share>:
...
80105a06:	78 18                	js     80105a20 <sys_set_cpu_share+0x30>
        return -1;

    return set_cpu_share(portion);
80105a08:	83 ec 0c             	sub    $0xc,%esp
80105a0b:	ff 75 f4             	pushl  -0xc(%ebp)
80105a0e:	e8 8d e9 ff ff       	call   801043a0 <set_cpu_share>
...
80105a67:	c7 04 c5 c2 53 11 80 	movl   $0x8e000008,-0x7feeac3e(,%eax,8)
80105a6e:	08 00 00 8e 
80105a72:	66 89 14 c5 c0 53 11 	mov    %dx,-0x7feeac40(,%eax,8)
80105a79:	80 
80105a7a:	c1 ea 10             	shr    $0x10,%edx
80105a7d:	66 89 14 c5 c6 53 11 	mov    %dx,-0x7feeac3a(,%eax,8)
80105a84:	80 
  for(i = 0; i < 256; i++)
...
80105a8f:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105a94:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a97:	c7 05 c2 55 11 80 08 	movl   $0xef000008,0x801155c2
80105a9e:	00 00 ef 
  initlock(&tickslock, "time");
80105aa1:	68 65 7a 10 80       	push   $0x80107a65
80105aa6:	68 80 53 11 80       	push   $0x80115380
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aab:	66 a3 c0 55 11 80    	mov    %ax,0x801155c0
80105ab1:	c1 e8 10             	shr    $0x10,%eax
80105ab4:	66 a3 c6 55 11 80    	mov    %ax,0x801155c6
  initlock(&tickslock, "time");
...
80105adb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105adf:	b8 c0 53 11 80       	mov    $0x801153c0,%eax
...
80105b20:	ff 24 85 0c 7b 10 80 	jmp    *-0x7fef84f4(,%eax,4)
...
80105b30:	e8 fb dc ff ff       	call   80103830 <myproc>
...
80105b61:	e8 ca dc ff ff       	call   80103830 <myproc>
80105b66:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b69:	e8 c2 dc ff ff       	call   80103830 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105b85:	68 c8 7a 10 80       	push   $0x80107ac8
80105b8a:	e8 d1 aa ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105b8f:	83 c4 20             	add    $0x20,%esp
80105b92:	e8 99 dc ff ff       	call   80103830 <myproc>
...
80105b9e:	e8 8d dc ff ff       	call   80103830 <myproc>
80105ba3:	85 c0                	test   %eax,%eax
80105ba5:	74 1d                	je     80105bc4 <trap+0xc4>
80105ba7:	e8 84 dc ff ff       	call   80103830 <myproc>
...
80105bc4:	e8 67 dc ff ff       	call   80103830 <myproc>
80105bc9:	85 c0                	test   %eax,%eax
80105bcb:	74 0b                	je     80105bd8 <trap+0xd8>
80105bcd:	e8 5e dc ff ff       	call   80103830 <myproc>
...
80105bd6:	74 68                	je     80105c40 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bd8:	e8 53 dc ff ff       	call   80103830 <myproc>
80105bdd:	85 c0                	test   %eax,%eax
80105bdf:	74 19                	je     80105bfa <trap+0xfa>
80105be1:	e8 4a dc ff ff       	call   80103830 <myproc>
...
80105c02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105c08:	e8 23 dc ff ff       	call   80103830 <myproc>
80105c0d:	8b 58 24             	mov    0x24(%eax),%ebx
80105c10:	85 db                	test   %ebx,%ebx
80105c12:	0f 85 e8 00 00 00    	jne    80105d00 <trap+0x200>
    myproc()->tf = tf;
80105c18:	e8 13 dc ff ff       	call   80103830 <myproc>
80105c1d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105c20:	e8 bb ef ff ff       	call   80104be0 <syscall>
    if(myproc()->killed)
80105c25:	e8 06 dc ff ff       	call   80103830 <myproc>
...
80105c5d:	e8 ee ca ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c62:	e8 c9 db ff ff       	call   80103830 <myproc>
...
80105c74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c78:	e8 93 c9 ff ff       	call   80102610 <kbdintr>
    lapiceoi();
80105c7d:	e8 ce ca ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c82:	e8 a9 db ff ff       	call   80103830 <myproc>
...
80105c9d:	e8 ae ca ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ca2:	e8 89 db ff ff       	call   80103830 <myproc>
...
80105cbf:	e8 4c db ff ff       	call   80103810 <cpuid>
80105cc4:	56                   	push   %esi
80105cc5:	53                   	push   %ebx
80105cc6:	50                   	push   %eax
80105cc7:	68 70 7a 10 80       	push   $0x80107a70
80105ccc:	e8 8f a9 ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105cd1:	e8 7a ca ff ff       	call   80102750 <lapiceoi>
    break;
80105cd6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cd9:	e8 52 db ff ff       	call   80103830 <myproc>
...
80105cec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105cf0:	e8 8b c3 ff ff       	call   80102080 <ideintr>
80105cf5:	e9 63 ff ff ff       	jmp    80105c5d <trap+0x15d>
80105cfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d00:	e8 6b e1 ff ff       	call   80103e70 <exit>
80105d05:	e9 0e ff ff ff       	jmp    80105c18 <trap+0x118>
80105d0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105d10:	e8 5b e1 ff ff       	call   80103e70 <exit>
80105d15:	e9 aa fe ff ff       	jmp    80105bc4 <trap+0xc4>
80105d1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105d20:	83 ec 0c             	sub    $0xc,%esp
80105d23:	68 80 53 11 80       	push   $0x80115380
80105d28:	e8 b3 e9 ff ff       	call   801046e0 <acquire>
      wakeup(&ticks);
80105d2d:	c7 04 24 c0 5b 11 80 	movl   $0x80115bc0,(%esp)
      ticks++;
80105d34:	83 05 c0 5b 11 80 01 	addl   $0x1,0x80115bc0
      wakeup(&ticks);
80105d3b:	e8 80 e4 ff ff       	call   801041c0 <wakeup>
      release(&tickslock);
80105d40:	c7 04 24 80 53 11 80 	movl   $0x80115380,(%esp)
80105d47:	e8 54 ea ff ff       	call   801047a0 <release>
80105d4c:	83 c4 10             	add    $0x10,%esp
80105d4f:	e9 09 ff ff ff       	jmp    80105c5d <trap+0x15d>
80105d54:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d57:	e8 b4 da ff ff       	call   80103810 <cpuid>
...
80105d65:	68 94 7a 10 80       	push   $0x80107a94
80105d6a:	e8 f1 a8 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105d6f:	83 c4 14             	add    $0x14,%esp
80105d72:	68 6a 7a 10 80       	push   $0x80107a6a
...
80105e6c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e6f:	bb 8c 7b 10 80       	mov    $0x80107b8c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801069da:	e8 11 de ff ff       	call   801047f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a7d:	68 94 7b 10 80       	push   $0x80107b94
...
80106b33:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b36:	e8 d5 cc ff ff       	call   80103810 <cpuid>
...
80106bc0:	a1 c4 5b 11 80       	mov    0x80115bc4,%eax
{
...
80106c0f:	e8 7c cb ff ff       	call   80103790 <mycpu>
80106c14:	89 c6                	mov    %eax,%esi
80106c16:	e8 75 cb ff ff       	call   80103790 <mycpu>
80106c1b:	89 c7                	mov    %eax,%edi
80106c1d:	e8 6e cb ff ff       	call   80103790 <mycpu>
80106c22:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c25:	83 c7 08             	add    $0x8,%edi
80106c28:	e8 63 cb ff ff       	call   80103790 <mycpu>
...
80106d0b:	77 49                	ja     80106d56 <inituvm+0x66>
  mem = kalloc();
80106d0d:	e8 ae b7 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d1f:	e8 cc da ff ff       	call   801047f0 <memset>
...
80106d50:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d51:	e9 4a db ff ff       	jmp    801048a0 <memmove>
    panic("inituvm: more than a page");
80106d56:	83 ec 0c             	sub    $0xc,%esp
80106d59:	68 d9 7b 10 80       	push   $0x80107bd9
...
80106e7b:	e8 70 d9 ff ff       	call   801047f0 <memset>
...
80106ea9:	0f 86 81 00 00 00    	jbe    80106f30 <allocuvm+0x100>
    mem = kalloc();
80106eaf:	e8 0c b6 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106ebd:	68 11 7c 10 80       	push   $0x80107c11
...
80106ef3:	68 29 7c 10 80       	push   $0x80107c29
...
80106f1b:	e8 f0 b3 ff ff       	call   80102310 <kfree>
      return 0;
...
80106fde:	e8 2d b3 ff ff       	call   80102310 <kfree>
...
80106ff3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ff4:	e9 17 b3 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106ff9:	83 ec 0c             	sub    $0xc,%esp
80106ffc:	68 45 7c 10 80       	push   $0x80107c45
...
80107015:	e8 a6 b4 ff ff       	call   801024c0 <kalloc>
...
80107030:	e8 bb d7 ff ff       	call   801047f0 <memset>
...
8010709b:	a3 c4 5b 11 80       	mov    %eax,0x80115bc4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070cf:	68 56 7c 10 80       	push   $0x80107c56
...
80107120:	e8 7b d7 ff ff       	call   801048a0 <memmove>
...
80107175:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107178:	e8 43 b3 ff ff       	call   801024c0 <kalloc>
...
8010724f:	e8 4c d6 ff ff       	call   801048a0 <memmove>
    len -= n;
    buf += n;
